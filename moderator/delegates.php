...
<body class="bg-light">
    ...
    <div class="container">
        <div class="pt-4 d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Roster of Delegates</h1>
            <div class="btn-toolbar mb-2 mb-md-0">
                <div class="btn-group me-2">
                    <a href="delegate-create.php" class="btn btn-sm btn-outline-success">Add New</a>
                </div>
            </div>
        </div>
                ...
                <?php if($delegates):?>
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row"><?php echo $delegate["delegate_id"]; ?></th>
                                ...
                                <?php endif; ?>
                                <!-- <td><a href="delegate-history.php?delegate_id=<?php // echo $delegate['delegate_id']; ?>">View Record</a></td> -->
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
