...
<body class="bg-light">
    ...
    <div class="container">
        <div class="py-3 text-center">
            ...
            <h2>Create a Vote</h2>
            <p class="lead">Fill out this form to create a new vote.</p>
        </div>
            ...
            <div class="col-md-12 d-flex justify-content-center order-md-1">
                ...
                <div class="row mx-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="caucus" name="caucus" placeholder="Caucus" required="">
                        <div class="invalid-feedback">
